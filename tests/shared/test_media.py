...
class TestTVShowList(unittest.TestCase):
    ...
    def test_tvshowlist_is_empty(self) -> None:
    ...
    def test_tvshowlist_add_tvshow(self) -> None:
    ...
    def test_tvshowlist_get_tvshow(self) -> None:
    ...
    def test_tvshow_get_tvdbid(self) -> None:
    ...
    def test_tvshowepisode_get_id(self) -> None:
        ...
        episode: TVShowEpisode = TVShowEpisode("Code Geass (2006) - s01e01 - The Day a New Demon Was Born")
